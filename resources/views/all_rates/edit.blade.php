            ...
            <div class="p-4 relative h-full w-full text-center bg-white rounded-2xl shadow-lg white:bg-gray-800 white:border-gray-700">
                ...
                <form class="mt-5" action="{{ route('allowancerate.update',$ar->employee_id) }}" method='POST'>
                    ...
                    <div class="flex flex-row justify-between appends" id="appends0">
                        <div class="px-3 w-3/4">
                            <select name="allowance_name[]" id="allowance_name{{$x}}" class=" w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40 allowance_name" onchange='check_duplicate()'>
