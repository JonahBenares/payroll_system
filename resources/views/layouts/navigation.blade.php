                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container3" x-bind:style="selected == 5 ? 'max-height: ' + $refs.container3.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="{{ route('changeSched.index') }}" class="w-full text-sm font-thin text-gray-500 white:text-gray-200 flex items-center px-7 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Change chedule</a>
                                    </li>
                                </ul>
                            </div>
                        </li>    
