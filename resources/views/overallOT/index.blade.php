    ...
    <div class="overflow-auto h-screen pb-28 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                ...
                <form class="items-center" action="{{ route('filter_overallot') }}" method="POST"> 
                    @csrf
                ...
                <div class="flex mt-5 uppercase">
                    <div class="flex mt-5 uppercase">
                        <p class="text-left text-md uppercase text-gray-600 pt-2 leading-none"><span class="font-semibold pr-1">{{ (isset($date_from)) ? date('F d,Y',strtotime($date_from)) : '' }} - {{ (isset($date_to)) ? date('F d,Y',strtotime($date_to)) : '' }}</span></p>
                    </div>
                </div>
                                ...
                                @foreach($data2 AS $ort)
                                    <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                        ...
                                        <td scope="row" class="align-top border border-gray-200  py-2 px-2 text-gray-900 whitespace-nowrap white:text-white" align="center">
                                            <p>{!! implode("<br />",$ort['overtime_date']) !!}</p>
                                        </td>
                                        <td scope="row" class="align-top border border-gray-200 py-2 px-2 text-gray-900 whitespace-nowrap white:text-white" align="center">
                                            <p>
                                            {!! implode("<br />",$ort['overtime_type']) !!}
                                            </p>
                                        </td>
                                        <td scope="row" class="align-top border border-gray-200 py-2 px-2 text-gray-900 whitespace-nowrap white:text-white" align="center">
                                            <p>{!! implode("<br />",$ort['overtime_sum']) !!}</p>
                                        </td>
                                        <td scope="row" class="text-right  align-top border border-gray-200 py-2 px-2 text-gray-900 whitespace-nowrap white:text-white" align="center">
                                            <p>{!! implode("<br />",$ort['overtime_amount']) !!}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
