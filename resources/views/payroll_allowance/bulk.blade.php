        ...
        <div class="">
            <div class="">   
                <table class="border border-x border-y border-gray-300 mt-2 text-xs w-full">
                    ...
                    <tr>
                        <td>Company</td>
                        <td class="border-b">{{ getBUName($det->employee_id) }}</td>
                        <td ></td>
                        <td>Date:</td>
                    ...
                    <tr>
                        <td>Pay To:</td>
                        <td class="border-b">{{ getEmployeeName($det->employee_id) }}</td>
                        <td></td>
                        <td>Due Date:</td>
                        <td class="border-b"></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="5">
                            <table class="w-full">
                                ...
                                <tr>
                                    <td colspan="3" class="border-r pl-20"><b> {{ getAllowanceName($head_id) }}for Period {{ date("M j, Y",strtotime($from)) }} to {{ date("M j, Y", strtotime($to)) }} @ Php {{ getAllowance($det->id, $head_id, 'amount') }}</b></td>
                                    <td class=" text-center">Php</td>
                                    <td class=" text-right">{{ number_format($det->total_allowance,2) }}</td>
                                </tr>
                                <tr>
                        ...
                        <td colspan="5">
                            <table class="w-full">
                                ...
                                <tr>
                                    ...
                                    <td class=" text-center font-bold">{{ getEmployeeName($det->employee_id) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
