            ...
            <form action="{{ route('changeSched.update',$cs->id) }}" method='POST'>
                ...
                <div class="mt-4 w-full  flex">
                    <div class="flex items-center">
                        <input name="night_shift" type="checkbox" value="1" class=" w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 white:focus:ring-blue-600 white:ring-offset-gray-800 focus:ring-2 white:bg-gray-700 white:border-gray-600" {{ ($cs->night_shift!=0) ? 'checked' : '' }}>
