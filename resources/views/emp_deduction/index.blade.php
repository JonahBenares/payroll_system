                            ...
                            <tr class="bg-white text-gray-500 font-medium hover:bg-gray-50 hover:text-gray-900 hover:font-semibold">
                                ...
                                <td class="border border-gray-200 py-3 px-3 align-top">
                                    ...
                                    @foreach($deductions AS $r)
                                        ...
                                        @endphp
                                        <div class="justify-between flex">
                                            <span class="relative">{{ $r->description }}</span>
                                            <span class="relative">{{ number_format($r->employee_rate,2) }}</span>
                                        </div>
                                        @endif
                                    @endforeach 
                                </td>
                                <td class="py-3 px-3 justify-center flex " >
                                    @if(in_array($e->personal_id,$personal_id))
                                        <a href="{{ route('empDeduction.edit', $e->id) }}" class="" title="Update">
                                    ...
                                    @else
                                        <a href="{{ route('empDeduction.create',['employee_id' => $e->id, 'personal_id' => $e->personal_id]) }}" class="" title="Add">
