                ...
                <div class="p-4">
                    ...
                    {!! csrf_field() !!}
                        ...
                        <div class="">
                            ...
                            <input type="text" name="schedule_code" id="schedule_code" value="{{$schedule->schedule_code}}"  class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                        </div>
                        
                        <div class="flex justify-between space-x-2">
                            <div class="mt-4 w-full ">
                                <label class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Time In</label>
                                <input type="time" name="time_in" id="time_in" value="{{$schedule->time_in}}" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                            </div>
                            <div class="mt-4 w-full ">
                                <label class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Time Out</label>
                                <input type="time" name="time_out" id="time_out" value="{{$schedule->time_out}}" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                            </div>
                        </div> 
