        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-2xl shadow-lg white:bg-gray-800 white:border-gray-700">
                ...
                <div class="flex justify-center space-x-2">
                    ...
                    <a href="{{ route('adjustment_computation',['month'=>$filters['month'],'year'=>$filters['year'],'cutoff'=>$filters['cutoff']]) }}" class="flex items-center justify-center px-3 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-indigo-500 rounded-2xl white:bg-indigo-600 white:hover:bg-indigo-700 white:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
                                                    ...
                                                    <table class="w-full text-sm text-left">
                                                        ...
                                                        <tr class="bg-white border-b">
                                                            <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap ">{{ $pi->description }}</td>
                                                                @if($pi->editable == 1)
                                                                <td align="right"><input type="text" name="adjustment_{{ $pi->id }}_{{ $x }}" id="adjustment_{{ $pi->id }}_{{ $x }}" onblur = "salary_computation('adjustment',{{ $pi->id }}, {{ $x }})" value="0" class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" ></td>
                                                                @else
                                                                <td align="right">
                                                            ...
                                                            @if($pi->pay_type == 3)
                                                                ...
                                                                @if($deduc_sched==$cutoff_type || $deduc_sched == "")
                                                                    <tr class="bg-white border-b">
                                                                        <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap ">{{ $pi->description }}</td>
                                                                            @if($pi->editable == 1)
                                                                            <td align="right"><input type="text" name="deductions_{{ $pi->id }}_{{ $x }}" id="deductions_{{ $pi->id }}_{{ $x }}" onblur = "salary_computation('deductions',{{ $pi->id }}, {{ $x }})" value='0' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm text-right rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required></td>
                                                                            @else
