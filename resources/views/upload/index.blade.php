        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                ...
                <div class=" hover:overflow-x-auto overflow-x-hidden h-100 max-h-100 pt-2 pr-2 pl-2 mt-3 md:pt-0 md:pr-0 md:pl-0 border">
                    <table class="text-sm text-left text-gray-500 white:text-gray-400 border-collapse">
                        ...
                        <tbody>
                           ...
                           $counter = 1; @endphp
                            ...
                            <input type="hidden" id="d1_amount_{{ $counter }}" value="{{ $d1_amount }}">
                            <input type="hidden" id="d2_amount_{{ $counter }}" value="{{ $d2_amount }}">
                            <input type="hidden" id="d3_amount_{{ $counter }}" value="{{ $d3_amount }}">
                            <input type="hidden" id="d4_amount_{{ $counter }}" value="{{ $d4_amount }}">
                            <input type="hidden" id="d5_amount_{{ $counter }}" value="{{ $d5_amount }}">
                            <input type="hidden" id="d6_amount_{{ $counter }}" value="{{ $d6_amount }}">
                            <input type="hidden" id="d7_amount_{{ $counter }}" value="{{ $d7_amount }}">
                    ...
                    <input type="hidden" name="business_unit" value="{{ $post_data['bu_id'] }}">
                </div>
