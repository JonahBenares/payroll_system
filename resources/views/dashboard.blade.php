    ...
    <div class="overflow-auto h-screen pb-24 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
        <div class="flex flex-col flex-wrap sm:flex-row ">
            ...
            <div class="w-5/12">
                ...
                {{-- <div class="mb-2">
                    <div class="shadow-md rounded-lg p-4 bg-white white:bg-gray-700 w-full">
                        <p class="font-bold text-md text-black white:text-white">
                            Messages
                        </p>
                        <ul>
            ...
            {{-- <div class="w-full sm:w-1/2 xl:w-1/3">
                <div class="mb-4">
                    <div class="shadow-md rounded-2xl p-4 bg-white white:bg-gray-700 w-full">
            ...
            <div class="w-full sm:w-1/2 xl:w-1/3">
                <div class="mb-4 mx-0 sm:ml-4 xl:mr-4">
                    <div class="shadow-md rounded-2xl bg-white white:bg-gray-700 w-full">
                        <p class="font-bold text-md p-4 text-black white:text-white">
                            My Tasks
                            <span class="text-sm text-gray-500 white:text-gray-300 white:text-white ml-2">
                                (05)
            ...
            <div class="w-full sm:w-1/2 xl:w-1/3">
                <div class="mb-4">
                    <div class="shadow-md rounded-2xl p-4 bg-white white:bg-gray-700">
                        <div class="flex flex-wrap overflow-hidden">
                            <div class="w-full rounded shadow-sm">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="text-left font-bold text-xl text-black white:text-white">
