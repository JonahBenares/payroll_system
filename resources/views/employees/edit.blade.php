    ...
    <div class="overflow-auto h-screen pb-28 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
		<div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full bg-white rounded-2xl shadow-lg white:bg-gray-800 white:border-gray-700">
                ...
                <form method="POST" class="mt-2" action ="{{ route('emp.update', $e) }}" >
                    @method('PUT')
                    @csrf
                   <div class="flex ">
                 ...
                 @for($c=0;$c < count($data); $c++)
                        ...
                        <div class="flex ">
                            <div class="mt-4 w-full px-2">
                                ...
                                <input type="number" name="{{ 'dependent_'.$data[$c]['id']}}" value="{{ $data[$c]['no_of_dependent'] }}" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40"> 
                            </div>
                        </div>
