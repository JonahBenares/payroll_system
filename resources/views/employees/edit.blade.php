                    ...
                    <form method="POST" action ="{{ route('emp.update', $e) }}" >
                        ...
                        <div class="flex justify-between space-x-2 mt-4">
                            ...
                            <div class="flex w-4/12 pt-8">
                                <input class="w-6 h-6 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500" name="supervisory" id="supervisory"  type="checkbox" value="1" {{ (( $e->supervisory==1 ) ? "checked" : "") }} >
