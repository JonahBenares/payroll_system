        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex space-x-2 pb-5">
                    <a href="<?php echo e(route('otOffice.index')); ?>" class="hover:bg-blue-200 hover:text-white bg-gray-100  text-sm px-5 py-1 rounded-2xl text-gray-300 font-bold">OT Office</a>
                    <a href="<?php echo e(route('otSite.index')); ?>" class="hover:bg-emerald-300 bg-emerald-500 text-sm px-6 py-1 rounded-2xl text-white font-bold">OT Site</a>
                </div>
                <form action="<?php echo e(route('filter_otsite')); ?>" method='POST'>
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('otSite.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class=" hover:overflow-x-auto overflow-x-hidden h-100 max-h-100 pt-2 pr-2 pl-2 mt-3 md:pt-0 md:pr-0 md:pl-0 ">
                                ...
                                <?php $__currentLoopData = $adjustment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="appendsadj" id="appendsadj0">
                                        <td class="border border-gray-300 text-left">
                                            <input type="hidden" name="adjustment_det_id[]" class="text-sm p-0 w-full border-0 px-2" value="<?php echo e((!empty($adj->id)) ? $adj->id : '0'); ?>">
                                        ...
                                        <td class="border border-gray-300 px-2 text-right text-xs flex justify-between space-x-1 addmoreappendadj">
                                            <input type="text" name="total_amount[]" id="total_amount" class="text-xs p-0 w-full border-0 px-2 text-right total_amount" value="<?php echo e($adj->total_amount); ?>" onchange="calculateAdjustment()" <?php echo e(($adj->amount=='0' && $adj->days_hr=='0' && $adj->total_amount!='0') ? 'style=background:#17f3f3;' : ''); ?>>
                                            <button class="text-sm bg-blue-600 text-white round-md p-1 addAdjustment">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd" />
                                                </svg>
                                            </button>
                                            <a id="delete_func<?php echo e($x); ?>" href="<?php echo e(route('destroy',['id'=>$adj->id,'emp_id'=>$adj->employee_id])); ?>" class="flex items-center justify-center px-1 py-1 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-500 white:bg-red-600 white:hover:bg-1red-700 white:focus:bg-red-700 hover:bg-red-600 focus:outline-none focus:bg-red-500 focus:ring focus:ring-red-300 focus:ring-opacity-50 delete_func" title="Delete" onclick="return confirm('Are you sure you want to delete this record?');">
                        ...
                        <input type="hidden" name="location_id" value="<?php echo e((!empty($location_id)) ? $location_id : '0'); ?>">
                        <input type="hidden" name="personal_id" value="<?php echo e((!empty($personal_id)) ? $personal_id : '0'); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/ot_site/index.blade.php ENDPATH**/ ?>