        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex space-x-2 pb-5">
                    <a href="<?php echo e(route('otOffice.index')); ?>" class="hover:bg-blue-200 hover:text-white bg-gray-100  text-sm px-5 py-1 rounded-2xl text-gray-300 font-bold">DTR Office</a>
                    <a href="<?php echo e(route('otSite.index')); ?>" class="hover:bg-emerald-300 bg-emerald-500 text-sm px-6 py-1 rounded-2xl text-white font-bold">DTR Site</a>
                </div>
                <form action="">
