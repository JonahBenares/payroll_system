            ...
            <table class="relative max-h-100 text-sm text-left text-gray-500 white:text-gray-400" width="150%">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 white:bg-gray-700 white:text-gray-400 sticky top-0 z-10">
                    <tr>
                        ...
                        <th scope="col" width="30%" class="py-3 px-3 sticky left-0 bg-gray-50">
                            Employee Name
                        </th>
                        ...
                        <th scope="col" class="py-3 px-6 sticky right-0 bg-gray-50" width="5%" align="center">
                ...
                <tbody>
                    <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600 ">
                        ...
                        <td class="py-4 px-6 sticky right-0 bg-white" align="center">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/masterfile/employee_list.blade.php ENDPATH**/ ?>