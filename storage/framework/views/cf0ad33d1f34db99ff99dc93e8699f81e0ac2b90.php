                ...
                <div class="flex justify-between pb-2 bg-white white:bg-gray-900">
                    <div > 
                        <h2 class="uppercase font-semibold py-2 flex">
                            ...
                            <span class="ml-2"> <?php echo e($employee->full_name); ?> </span>
                        </h2>
                    </div>
                    <div class="flex">
                        <a href="<?php echo e(route('leavefailure.index')); ?>"   type="button">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 white:text-gray-400">
                            ...
                            <?php if(!empty($leave)): ?>
                                ...
                                <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700">
                                    ...
                                    <?php if($l->leave_type == 'Undertime/Tardiness'): ?>
                                    <td class="py-3 px-3">
                                        <input type="text" name="undertime_mins[]" value="<?php echo e($l->undertime_mins); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1 text-center">  
                                    </td>
                                    <?php else: ?>
                                    <td class="py-3 px-3">  
                                    </td>
...
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/leave/edit.blade.php ENDPATH**/ ?>