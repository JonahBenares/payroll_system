                    ...
                    <table class="w-full text-sm text-left text-gray-500 white:text-gray-400">
                        ...
                        <?php $__currentLoopData = $deduction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                ...
                                <td class="py-3 px-6"><?php echo e($deduct->deduction_frequency); ?></td>
                                <td class="py-3 px-6"><?php echo e($deduct->deduction_period); ?></td>
                                <td class="py-3 px-6 flex justify-center" align="center">
                                    <a href="<?php echo e(route('deduct.edit', $deduct->id)); ?>" class="" title="Update">
                                    ...
                                    <form method="post" action="<?php echo e(route('deduct.destroy',$deduct->id)); ?>" accept-charset="UTF-8" style="display:inline">
