        ...
        <div class="flex flex-col flex-wrap sm:flex-row">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex justify-between pb-2 bg-white white:bg-gray-900">
                    ...
                    <div class="flex">
                        <a href="<?php echo e(route('hmorate.index')); ?>" type="button">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('hmorate.update',$hmo->id)); ?>" method='POST'>
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="px-2">
                        <label for="" class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Description</label>
                        <input name="level_description" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40" value="<?php echo e($hmo->level_description); ?>">
                    </div>
                    <div class="px-2 mt-2">
                        <label for="" class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Rate </label>
                        <input name="hmo_rate" onkeypress="return isNumberKey(this, event)"  class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40" value="<?php echo e($hmo->hmo_rate); ?>">
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/hmo/edit.blade.php ENDPATH**/ ?>