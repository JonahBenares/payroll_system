                                ...
                                <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                                    ...
                                    >
                                        <div class="flex items-center justify-between space-x-4 px-2">
                                            <h1 class="text-xl font-medium text-gray-800 ">Add New</h1>
                                        ...
                                        <form class="mt-5">
                                            ...
                                            <div class="flex ">
                                                <div class="mt-4 w-full px-2">
                                                    <label class="block text-sm text-gray-700 capitalize white:text-gray-200">Filed Date</label>
                                                ...
                                                <div class="mt-4 w-full px-2">
                                                    <label class="block text-sm text-gray-700 capitalize white:text-gray-200">Month</label>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/filing/swap_list.blade.php ENDPATH**/ ?>