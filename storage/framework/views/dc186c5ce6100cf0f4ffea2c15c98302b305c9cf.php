        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex justify-between pr-4 pl-4 pt-4 rounded-t-lg ">
                    ...
                    <div class="flex">
                        <a href="<?php echo e(route('payslip_info.create')); ?>" type="button" >
                    ...
                    <table class="w-full text-sm text-left text-gray-500 white:text-gray-400" id="table_overall">
                        ...
                        <?php $__currentLoopData = $payslip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="">
                                ...
                                <td align="center" class="py-3 px-6">
                                ...
                                <td align="center" class="py-3 px-6  whitespace-nowrap white:text-white">
                                    <?php if($pay->visible==0): ?>
                                        <span class="text-red-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                ...
                                <td class="py-3 px-6 justify-center flex" align="center">
                                    ...
                                    <button type="submit" onclick="return confirm(&quot;Are you sure you want to delete this record?&quot;)"  class="py-2 px-2  ml-1 text-xs font-medium text-center text-white bg-red-500 rounded-2xl hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-blue-300 white:bg-blue-600 white:hover:bg-red-500 white:focus:ring-blue-800" title="Update"> 
