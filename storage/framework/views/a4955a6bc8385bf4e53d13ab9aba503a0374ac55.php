    ...
    <div class="overflow-auto h-screen pb-28 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-2xl shadow-lg white:bg-gray-800 white:border-gray-700">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('payslip_info.update',$payslip->id)); ?>" method='POST' class="mt-5">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="px-2">
                        ...
                        <input type="text" name="description" id="description" value="<?php echo e($payslip->description); ?>" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                    </div>
