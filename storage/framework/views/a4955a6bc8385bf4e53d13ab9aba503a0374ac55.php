                            ...
                            <div class="w-1/4">
                                <div class="flex justify-center space-x-10">
                                    ...
                                    <div class="flex items-right mt-10">
                                        ...
                                        <input class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500" name="visible" id="visible"  type="checkbox" value="1" <?php echo e(($payslip->visible  == 1) ? 'checked' : ''); ?>>
