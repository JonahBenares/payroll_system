...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-powergrid::components.table-base','data' => ['theme' => $theme->table]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['theme' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($theme->table)]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <tr class="<?php echo e($theme->table->trClass); ?>" style="<?php echo e($theme->table->trStyle); ?>">
            ...
            <?php if($checkbox): ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-powergrid::components.checkbox-all','data' => ['checkbox' => $checkbox,'theme' => $theme->checkbox]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-powergrid::components.cols','data' => ['column' => $column,'theme' => $theme,'sortField' => $sortField,'sortDirection' => $sortDirection,'enabledFilters' => $enabledFilters]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php else: ?>
                    <tr style="<?php echo e($theme->table->trBodyStyle); ?>"
                        ...
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-powergrid::components.actions','data' => ['primaryKey' => $primaryKey,'tableName' => $tableName,'theme' => $theme,'row' => $row,'actions' => $actions]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\vendor\power-components\livewire-powergrid\src\Providers/../../resources/views/components/table.blade.php ENDPATH**/ ?>