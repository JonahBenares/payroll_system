        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex justify-between pr-4 pl-4 pt-4 rounded-t-lg">
                    <div > 
                        <h2 class="uppercase font-semibold py-2">Schedule List</h2>
                    </div>
                    <div class="flex">
                        <a href="<?php echo e(route('schedules.create')); ?>"  type="button" >
                ...
                <div class="overflow-x-auto overflow-y-hidden hover:overflow-y-auto h-100 relative p-4 rounded-b-lg">
                    <table class="w-full text-sm text-left text-gray-500 white:text-gray-400" id="table_overall">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $sched; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="bg-white text-gray-500 font-medium hover:bg-gray-50 hover:text-gray-900 hover:font-semibold">
                                <th scope="row" class="py-3 px-6 font-medium text-gray-900 whitespace-nowrap white:text-white"><?php echo e($sc->schedule_code); ?></th>
                                <td class="py-3 px-6"><?php echo e(date('h:i A', strtotime($sc->time_in))); ?></td>
                                <td class="py-3 px-6"><?php echo e(date('h:i A', strtotime($sc->time_out))); ?></td>
                                <td class="py-3 px-6 flex justify-center" align="center">
                                    <a href="<?php echo e(route('schedules.edit',$sc->id)); ?>" class="" title="Update">
                                    ...
                                    <button type="submit" onclick="return confirm(&quot;Are you sure you want to delete this record?&quot;)" class="ml-1 py-2 px-2 text-xs font-medium text-center text-white bg-red-500 rounded-2xl hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-blue-300 white:bg-blue-600 white:hover:bg-red-500 white:focus:ring-blue-800" title="Delete"> 
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/schedule/index.blade.php ENDPATH**/ ?>