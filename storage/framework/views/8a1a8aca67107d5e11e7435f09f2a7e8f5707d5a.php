        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="relative h-full w-full text-center bg-white rounded-lg shadow-lg">
                ...
                <div class="p-4">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('statutorybracket.update',$statutory->id)); ?>" method='POST'>
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="flex justify-between space-x-2 mt-4">
                            <div class="w-full">
                                ...
                                <input type="text" name="salary_from" id="salary_from" value="<?php echo e($statutory->salary_from); ?>" onkeypress="return isNumberKey(this, event)" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                            </div>
                            <div class="w-full">
                                <label class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Salary To</label>
                                <input type="text" name="salary_to" id="salary_to" value="<?php echo e($statutory->salary_to); ?>" onkeypress="return isNumberKey(this, event)" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                            </div>
                        </div>
                        <div class="flex justify-between space-x-2 mt-4">
                            <div class="w-full">
                                <label for="" class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Deductions</label>
                                <input type="text" name="deduction_amount" id="deduction_amount" value="<?php echo e($statutory->deduction_amount); ?>" onkeypress="return isNumberKey(this, event)" type="text" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                            </div>
                            <div class="w-full">
                                <label for="" class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">As of Date</label>
                                <input type="date" name="as_of" id="as_of" value="<?php echo e($statutory->as_of); ?>" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                            </div>
                        </div>
