                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container" x-bind:style="selected == 1 ? 'max-height: ' + $refs.container.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="<?php echo e(route('busUnit.index')); ?>" class="w-full text-sm font-thin text-gray-500 white:text-gray-200 flex items-center px-7 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Business Unit</a>
                                    </li>
                                </ul>
                            </div>
                        </li> 
                        <li class="relative ">
                            <a href="<?php echo e(route("shiftschedule.index")); ?>" class="w-full font-thin uppercase text-gray-500 white:text-gray-200 flex items-center px-4 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500 bg-gradient-to-r white:from-gray-700 white:to-gray-800" >
                                <span class="text-left">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container3" x-bind:style="selected == 5 ? 'max-height: ' + $refs.container3.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="<?php echo e(route('filedleave.index')); ?>" class="w-full text-sm font-thin text-gray-500 white:text-gray-200 flex items-center px-7 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Filed Leave</a>
                                    </li>
                                    <li class="relative">
                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" x-ref="container2" x-bind:style="selected == 2 ? 'max-height: ' + $refs.container2.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="<?php echo e(route("payroll_allowance.index")); ?>" class="w-full text-sm font-thin text-gray-500 white:text-gray-200 flex items-center px-7 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Allowance</a>
                                    </li>
                                    <li class="relative">
