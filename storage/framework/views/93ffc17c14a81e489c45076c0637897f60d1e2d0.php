            ...
            <div class="overflow-auto h-screen pb-24 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
                <div class="bg-white" x-data="{selected:0}">
                    <ul >  
                        ...
                        <li class="relative ">
                            <a class="w-full font-thin uppercase text-gray-500 white:text-gray-200 flex items-center px-4 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500 bg-gradient-to-r white:from-gray-700 white:to-gray-800" href="<?php echo e(route("dashboard")); ?>">
                                <span class="text-left">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" x-bind:style="selected == 5 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                                <ul>
                                    <li class="relative">
                                        <a href="<?php echo e(route('employee_list')); ?>" class="w-full text-sm font-thin text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Leave/Failure to Log In/Out</a>
                                    </li>
                                    <li class="relative">
                                        <a href="<?php echo e(route('schedule_list')); ?>" class="w-full font-thin text-sm text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Overtime</a>
                                    </li>
                                </ul>
                            </div>
                        </li>    
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" x-bind:style="selected == 2 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                                <ul>
                                    <li class="relative">
                                        <a href="<?php echo e(route('employee_list')); ?>" class="w-full text-sm font-thin text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Salary</a>
                                    </li>
                                    <li class="relative">
                                        <a href="<?php echo e(route('schedule_list')); ?>" class="w-full font-thin text-sm text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Allowance</a>
                                    </li>
                                    <li class="relative">
                                        <a href="<?php echo e(route('calendar_list')); ?>" class="w-full font-thin text-gray-500 text-sm white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Overtime</a>
                                    </li>
                                    <li class="relative">
                                        <a href="<?php echo e(route('calendar_list')); ?>" class="w-full font-thin text-gray-500 text-sm white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Bonus</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
