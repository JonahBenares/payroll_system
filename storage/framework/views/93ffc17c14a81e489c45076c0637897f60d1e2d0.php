                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container" x-bind:style="selected == 1 ? 'max-height: ' + $refs.container.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="<?php echo e(route('deduction_list')); ?>" class="w-full text-sm font-thin text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Deductions Rate</a>
                                    </li>
                                    <li class="relative">
                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" x-bind:style="selected == 5 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="<?php echo e(route('ot_list')); ?>" class="w-full font-thin text-sm text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Overtime</a>
                                    </li>
                                </ul>
                            </div>
                        </li>    
                        ...
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" x-ref="container2" x-bind:style="selected == 2 ? 'max-height: ' + $refs.container2.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="<?php echo e(route('payroll_allowance')); ?>" class="w-full font-thin text-sm text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Allowance</a>
                                    </li>
                                    <li class="relative">
                                        <a href="<?php echo e(route('payroll_overtime')); ?>" class="w-full font-thin text-gray-500 text-sm white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Overtime</a>
                                    </li>
                                    <li class="relative">
                                        <a href="<?php echo e(route('payroll_bonus')); ?>" class="w-full font-thin text-gray-500 text-sm white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Bonus</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="relative ">
                            ...
                            <div class="relative overflow-hidden transition-all max-h-0 duration-700" style="" x-ref="container1" x-bind:style="selected == 3 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                                <ul>
                                    ...
                                    <li class="relative">
                                        <a href="<?php echo e(route('schedule_list')); ?>" class="w-full font-thin text-sm text-gray-500 white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Sample 2</a>
                                    </li>
                                    <li class="relative">
                                        <a href="<?php echo e(route('calendar_list')); ?>" class="w-full font-thin text-gray-500 text-sm white:text-gray-200 flex items-center px-14 py-2 my-1 transition-colors duration-200 justify-start hover:text-blue-500" >Sample 3</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
