    ...
    >
        <?php if($column->editable === true && !str_contains($field, '.')): ?>
            <span class="<?php echo e($theme->clickToCopy->spanClass); ?>">
                <?php echo $__env->make($theme->editable->view, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php if($column->clickToCopy): ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-powergrid::components.click-to-copy','data' => ['row' => $row,'field' => $content,'label' => data_get($column->clickToCopy, 'label') ?? null,'enabled' => data_get($column->clickToCopy, 'enabled') ?? false]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\xampp\htdocs\payroll_system\vendor\power-components\livewire-powergrid\src\Providers/../../resources/views/components/row.blade.php ENDPATH**/ ?>