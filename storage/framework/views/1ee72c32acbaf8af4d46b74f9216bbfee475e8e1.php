        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex space-x-2 pb-5">
                    <a href="<?php echo e(route('dtrOffice.index')); ?>" class="hover:bg-blue-200 hover:text-white bg-gray-100  text-sm px-5 py-1 rounded-2xl text-gray-300 font-bold">DTR Office</a>
                    <a href="<?php echo e(route('dtrSite.index')); ?>" class="hover:bg-emerald-300 bg-emerald-500 text-sm px-6 py-1 rounded-2xl text-white font-bold">DTR Site</a>
                </div>
                <form action="">
                    <div class="flex justify-between space-x-4 w-full my-1">
                        ...
                        <div class="space-y-1 w-7/12">
                            <div class="flex justify-between space-x-2">
                                ...
                                <input type="text" class="px-0 text-sm bg-transparent focus-within:border-transparent border-0 text-left py-0 border-b border-gray-300 w-full">
                            </div>
                            <div class="flex justify-between space-x-2">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/dtr_site/index.blade.php ENDPATH**/ ?>