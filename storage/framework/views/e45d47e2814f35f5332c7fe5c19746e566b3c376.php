        ...
        <div class="flex flex-col flex-wrap sm:flex-row">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex justify-between  pb-2 bg-white white:bg-gray-900">
                    ...
                    <div class="flex">
                        <a href="<?php echo e(route('deductions.index')); ?>"  type="button">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('deductions.update',$deduction->id)); ?>" method='POST'>
                <?php echo csrf_field(); ?>

                    <?php echo method_field("PATCH"); ?>
                    <div class="px-2">
                        <label for="" class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Deduction Name</label>
                        <select name="payslip_info_id" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                        ...
                        <?php $__currentLoopData = $payslip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($p->id); ?>" <?php echo e(($p->id  == $deduction->payslip_info_id) ? 'selected' : ''); ?>><?php echo e($p->description); ?></option>
                    ...
                    <div class="flex ">
                        <div class="mt-4 w-full px-2">
                            ...
                            <select name="deduction_frequency" id="frequency" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                <option value="0">--Select Frequency--</option>
                                <option value="1" <?php echo e(($deduction->deduction_frequency  == 1) ? 'selected' : ''); ?>>Once a month</option>
                                <option value="2" <?php echo e(($deduction->deduction_frequency  == 2) ? 'selected' : ''); ?>>Twice a month</option>
                            </select>
                        </div>
                        <div class="mt-4 w-full px-2 <?php echo e(($deduction->deduction_frequency  == 1) ? '' : 'hidden'); ?>" id="period"> 
                            
                            <label class="block text-left text-sm text-gray-700 capitalize white:text-gray-200">Deduction Period</label>
                            <!-- <input class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40"> -->
                            <select name="deduction_period" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                ...
                                <option value="<?php echo e($c->id); ?>" <?php echo e(($c->id  == $deduction->deduction_period) ? 'selected' : ''); ?>><?php echo e($c->cutoff_type); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/deduct/edit.blade.php ENDPATH**/ ?>