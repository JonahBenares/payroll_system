        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="relative h-full w-full text-center bg-white rounded-lg shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex justify-between pr-4 pl-4 pt-4 rounded-t-lg">
                    <div > 
                        <h2 class="uppercase font-semibold py-2">Employee Deduction</h2>
                    </div>
                </div>
                            ...
                            <tr class="">
                                ...
                                <th scope="col" class="py-3 px-3 border border-gray-200" width="50%">
                                    <div class="justify-between flex">
                                        <span class="relative">Deduction Name</span>
                            ...
                            <tr class="bg-white text-gray-500 font-medium hover:bg-gray-50 hover:text-gray-900 hover:font-semibold">
                                ...
                                <td class="border border-gray-200 py-3 px-3 align-top">
                                    <?php 
                                        $personal_id=array(); 
                                    ?>
                                    <?php $__currentLoopData = $deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($e->id==$r->employee_id): ?>
                                        <?php 
                                            $personal_id[]=$r->personal_id;
                                        ?>
                                        <div class="justify-between flex">
                                            <span class="relative"><?php echo e($r->description); ?></span>
                                            <span class="relative"><?php echo e(number_format($r->employee_rate,2)); ?></span>
                                        </div>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                </td>
                                <td class="py-3 px-3 justify-center flex " >
                                    <?php if(in_array($e->personal_id,$personal_id)): ?>
                                        <a href="<?php echo e(route('empDeduction.edit', $e->id)); ?>" class="" title="Update">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('empDeduction.create',['employee_id' => $e->id, 'personal_id' => $e->personal_id])); ?>" class="" title="Add">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/emp_deduction/index.blade.php ENDPATH**/ ?>