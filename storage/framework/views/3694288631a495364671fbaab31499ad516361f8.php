                        ...
                        <tbody>
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                ...
                                <td class="border border-gray-200 py-3 px-3 align-top">
                                    <div class="justify-between flex">
                                        <span class="relative">Meal Allowance</span>
                                        <span class="relative">1,200.00</span>
                                    </div> 
                                </td>
                                <td class="py-3 px-6 justify-center flex" >
                                    <a href="<?php echo e(route('empDeduction.edit', '1')); ?>" class="" title="Update">
                                    ...
                                    <a href="<?php echo e(route('empDeduction.create')); ?>" class="" title="Add">
