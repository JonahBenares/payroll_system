...
>>>>>>> 33c23391486d36c67f5b448d0a20f8dd49cedec9
                ...
                <div class="overflow-x-auto overflow-y-hidden hover:overflow-y-auto h-100 relative max-h-100 pt-2 pr-2 pl-2 mt-3 md:pt-0 md:pr-0 md:pl-0 sm:rounded-2xl">
                    <table class="w-full text-sm text-left text-gray-500 white:text-gray-400">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $bonus_report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <?php if($bonus_type != ''): ?>
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                ...
                                <td scope="row" class="py-3 px-3 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                    <input type="text" name="total_amount" id="total_amount" value="<?php echo e(number_format($b->monthly_rate,4)); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                                </td>
                                <?php elseif($bonus_type == 'Healthy'): ?>
                                <td scope="row" class="py-3 px-6 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                ...
                                <td scope="row" class="py-3 px-3 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                <input type="text" name="total_amount" id="total_amount" value="<?php echo e(number_format($b->daily_rate,4)); ?>" readonly="readonly" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                                </td>
                                <?php elseif($bonus_type == '13th Month'): ?>
                                <td scope="row" class="py-3 px-6 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                </td>
                                <td scope="row" class="py-3 px-3 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                    <input type="text" name="total_amount" id="total_amount" value="<?php echo e(number_format($b->monthly_rate,4)); ?>" onkeypress="return isNumberKey(this, event)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                                </td>
                                <?php endif; ?>
