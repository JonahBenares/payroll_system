						...
						<tbody>
							<tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
								...
								<td class="py-3 px-6 flex justify-center " align="center">
									<a href="<?php echo e(route('holiday_update')); ?>" class="" title="Update">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/masterfile/holiday_list.blade.php ENDPATH**/ ?>