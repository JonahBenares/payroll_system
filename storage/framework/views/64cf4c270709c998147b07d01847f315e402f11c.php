        ...
        <div class="flex flex-col flex-wrap sm:flex-row">
            <div class="p-4 relative h-full w-full text-center  bg-white rounded-2xl shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex justify-between  pb-4 bg-white white:bg-gray-900">
                    <div > 
                        <h2 class="uppercase font-semibold py-2">Adjustment Rates</h2>
                    </div>
                    <div class="flex">
                        <a href="<?php echo e(route('adjustmentrate.create')); ?>"  class="flex items-center justify-center px-2 py-1 mx-2 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-indigo-500 rounded-2xl white:bg-indigo-600 white:hover:bg-indigo-700 white:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
...
<<<<<<< HEAD
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                ...
                                <td class="py-4 px-6 flex justify-center" align="center">
                                    <a href="<?php echo e(route('adjustmentrate.edit' , '1')); ?>" class="" title="Update">
                            ...
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                ...
                                <td class="py-4 px-6 flex justify-center" align="center">
                                    <a href="<?php echo e(route('adjustmentrate.edit' , '1')); ?>" class="" title="Update">
=======
                            <?php $__currentLoopData = $adjustmentrate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                ...
                                <td class="py-4 px-6">
                                    <?php echo e(($ar->deduction_type==1) ? 'Percentage' : 'Actual Amount'); ?>

                                </td>
                                <td class="py-4 px-6">
                                    <?php echo e(($ar->deduction_type==1) ? $ar->rate_amount * 100 ."%" : number_format($ar->rate_amount,2)); ?>

                                </td>
                                <td class="py-4 px-6 flex justify-center" align="center">
                                    <a href="<?php echo e(route('adjustmentrate.edit' , $ar->id)); ?>" class="" title="Update">
>>>>>>> af1388992479bd516bfb86455a1e0f9596c40e65
                                        <div class="py-2 px-2 text-xs font-medium text-center text-white transition-colors bg-indigo-500 rounded-2xl white:bg-indigo-600 white:hover:bg-indigo-700 white:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                                                <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" />
...
=======
                                    <form method="post" action="<?php echo e(route('adjustmentrate.destroy',$ar->id)); ?>" onsubmit="return confirm('Are you sure you want to delete this record?');">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/adjustments/index.blade.php ENDPATH**/ ?>