                        ...
                        <table class="text-sm text-left text-gray-500 white:text-gray-400 border-collapse">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                    ...
                                    <?php $__currentLoopData = getAllowanceTime($det->allowance_head_id, $det->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap white:text-white" align="center">
                                        <div x-data="{ tooltip: false }" class=" z-30 inline-flex">
                                            ...
                                            <div class="relative" x-cloak x-show.transition.origin.top="tooltip" style="left:25px;bottom:10px">
                                                ...
                                                <?php echo e($time->time_in . ' - ' . $time->time_out); ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap white:text-white" align="center">
                                        <input type="text" class="bg-transparent border-0 text-gray-900 text-sm block w-full p-2.5 text-center" disabled value="<?php echo e($det->total_days); ?>">
                                    </td>
                                    <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap white:text-white" align="center">
                                        <input type="text"  class="bg-transparent border-0 text-gray-900 text-sm block w-full p-2.5 text-right" disabled value="<?php echo e($det->allowance_amount); ?>">
                                    </td>
                                    <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap white:text-white" align="center">
                                        <input type="text" class="bg-transparent border-0 text-gray-900 text-sm block w-full p-2.5 text-right" disabled value="<?php echo e($det->OT_allowance_amount); ?>">
                                    </td>
                                    <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap white:text-white" align="center">
                                        <input type="text" name="total_amount[]" class="bg-transparent border-0 text-gray-900 text-sm block w-full p-2.5 text-right" disabled value="<?php echo e($det->total_allowance); ?>">
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
</script><?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/allowance_summary/index.blade.php ENDPATH**/ ?>