...
<?php $component->withAttributes([]); ?>
    ...
    <div id="cancelModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
        <div class="inline-block w-full max-w-lg p-8 my-20 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl lg:max-w-lg">
            <!-- Modal content -->
            <div class="relative ">
                <form action="<?php echo e(route('cancel_sched')); ?>" method='POST'>
                    <?php echo csrf_field(); ?>
                    <div class="">
                        <div class="px-2">
                ...
                <tbody class="sticky top-12">
                    <?php if(!empty($change_sched)): ?>
                        ...
                        <tr class=" border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                            ...
                            <td class="py-3 px-6"><?php echo e(date('F',strtotime($cs->month_year))); ?></td>
                            <td class="py-3 px-6"><?php echo e(date('Y',strtotime($cs->month_year))); ?></td>
                            ...
                            <td class="py-3 px-6 flex justify-center space-x-1" align="center">
                                ...
                                <button id="check_id" data-modal-target="cancelModal" data-modal-toggle="cancelModal" class="py-2 px-2 text-xs font-medium text-center text-white bg-red-500 rounded-2xl hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-blue-300 white:bg-blue-600 white:hover:bg-red-500 white:focus:ring-blue-800" type="button" data-id='<?php echo e($cs->id); ?>'>
                                    Cancel
                                </button>
                            </td>
                        </tr>
