                        ...
                        <div class="flex justify-between pt-4">
                            <div class="w-1/2 px-2">
                                ...
                                <div class="flex justify-between mt-2">
                                    ...
                                    <input type="text" onkeypress="return isNumberKey(this, event)" name="reg_day" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-56 p-2" value='<?php echo e((!empty($get_data->reg_day_hr)) ? $get_data->reg_day_hr : '0'); ?>'>
                                </div>
                                <div class="flex justify-between mt-2">
                                    <label for="rd2" class="block py-3 pr-3 text-sm font-medium text-gray-700 ">RD 2:</label>
                                    <input type="text" onkeypress="return isNumberKey(this, event)" name="rd2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-56 p-2" value='<?php echo e((!empty($get_data->RD_HR)) ? $get_data->RD_HR : '0'); ?>'>
                                </div>
                                <div class="flex justify-between mt-2">
                                    <label for="sh" class="block py-3 pr-3 text-sm font-medium text-gray-700 ">SH:</label>
                                    <input type="text" onkeypress="return isNumberKey(this, event)" name="sh" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-56 p-2" value='<?php echo e((!empty($get_data->SH_HR)) ? $get_data->SH_HR : '0'); ?>'>
                                </div>
                                <div class="flex justify-between mt-2">
                                    <label for="sh_rd" class="block py-3 pr-3 text-sm font-medium text-gray-700 ">SH on RD:</label>
                                    <input type="text" onkeypress="return isNumberKey(this, event)" name="sh_rd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-56 p-2" value='<?php echo e((!empty($get_data->SH_RD_HR)) ? $get_data->SH_RD_HR : '0'); ?>'>
                                </div>
                                <div class="flex justify-between mt-2">
                                    <label for="reg_hol" class="block py-3 pr-3 text-sm font-medium text-gray-700 ">Reg Hol:</label>
                                    <input type="text" onkeypress="return isNumberKey(this, event)" name="reg_hol" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-56 p-2" value='<?php echo e((!empty($get_data->RH_HR)) ? $get_data->RH_HR : '0'); ?>'>
                                </div>
                                <div class="flex justify-between mt-2">
                                    <label for="rh_rd" class="block py-3 pr-3 text-sm font-medium text-gray-700 ">RH on RD 2:</label>
                                    <input type="text" onkeypress="return isNumberKey(this, event)" name="rh_rd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-56 p-2" value='<?php echo e((!empty($get_data->RH_RD_HR)) ? $get_data->RH_RD_HR : '0'); ?>'>
                                </div>
                            </div>
