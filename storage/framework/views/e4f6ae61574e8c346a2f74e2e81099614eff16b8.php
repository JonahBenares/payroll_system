    ...
    <div class="overflow-auto h-screen pb-28 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-2xl shadow-lg white:bg-gray-800 white:border-gray-700">
                ...
                <?php if($filters['status'] == 'incomplete'): ?>
                ...
                <div class="overflow-x-auto overflow-y-hidden hover:overflow-y-auto h-64 relative pt-2 pr-2 pl-2 mt-3 md:pt-0 md:pr-0 md:pl-0 sm:rounded-2xl border border-yellow-500">
                    ...
                    <table  class="w-full text-sm text-left text-gray-500 white:text-gray-400">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $incompletelogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $il): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="py-2 px-6"><?php echo e(getEmployeeName($il->employee_id)); ?></td>
                                <td class="py-2 px-6"><?php echo e(date("M j, Y", strtotime($il->log_date))); ?></td>
                                <td class="py-2 px-6"><?php echo e($il->incomplete_time_desc); ?></td>
                ...
                <input type='hidden' name='year' value="<?php echo e($filters['year']); ?>">
                <input type='hidden' name='cutoff' value="<?php echo e($filters['cutoff']); ?>">
                <input type='hidden' name='status' value='generate'>
                </form>
                <?php endif; ?>

                <?php if($filters['status'] == 'generate'): ?>
                                                    ...
                                                    <table class="w-full text-sm text-left">
                                                        ...
                                                        <?php $__currentLoopData = $payslipinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($pi->pay_type == 2): ?>
                                                              <?php if($pi->description == "Absences/Undertime"): ?>
                                                                <?php $ded = undertimeCalc($emp['id'], $emp['personal_id'], $year, $month, $cutoff_type); ?>
                                                              <?php else: ?>
                                                                <?php $ded = 0;  ?>
                                                              <?php endif; ?>
                                                                <tr class="bg-white border-b">
                                                                    <td scope="row" class="py-2 px-2 font-medium text-gray-900 whitespace-nowrap "><?php echo e($pi->description); ?></td>
                                                                        ...
                                                                        <?php else: ?>
                                                                        <td><input type="text" name="less_gp_<?php echo e($pi->id); ?>_<?php echo e($x); ?>"  id="less_gp_<?php echo e($pi->id); ?>_<?php echo e($x); ?>" class="border-0 text-right" disabled value="<?php echo e($ded); ?>"></td>
                                                                        <input type="hidden" name="payslip_id_<?php echo e($pi->id); ?>" value="<?php echo e($pi->id); ?>">
                                                                        <?php endif; ?>
                                                                </tr>
