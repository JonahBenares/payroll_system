        ...
        <div class="flex flex-col flex-wrap sm:flex-row">
            <div class="relative h-full w-full text-center bg-white rounded-lg shadow-lg">
                <div class="flex justify-between pr-4 pl-4 pt-4 rounded-t-lg ">
                    <div> 
                        <h2 class="uppercase font-semibold py-2">Deduction Schedule <small class="border-l-2 px-1">Add New</small></h2>
                    </div>
                    <div class="flex">
                ...
                <div class="p-4">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(url('deductions')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                        <div class="flex justify-between space-x-2">
                            ...
                            <div class=" w-10/12 hidden" id="period">
                                ...
                                <select name="deduction_period" class="text-sm block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                    ...
                                    <option value="<?php echo e($c->id); ?>"><?php echo e($c->cutoff_type); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div> 
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\payroll_system\resources\views/deduct/create.blade.php ENDPATH**/ ?>