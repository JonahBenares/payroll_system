        ...
        <div class="flex flex-col flex-wrap sm:flex-row ">
            <div class="p-4 relative h-full w-full text-center bg-white rounded-2xl shadow-lg white:bg-gray-800 white:border-gray-700">
                <div class="flex justify-between  pb-4 bg-white white:bg-gray-900">
                    ...
                    <div class="flex">
                        <a href="{{ route('printBulkBonus') }}" class="flex items-center justify-center px-3 py-2 mx-2 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-lime-500 rounded-2xl white:bg-lime-600 white:hover:bg-lime-700 white:focus:bg-lime-700 hover:bg-lime-600 focus:outline-none focus:bg-lime-500 focus:ring focus:ring-lime-300 focus:ring-opacity-50">
                ...
                <div class="flex justify-center pb-1 pt-2 bg-white white:bg-gray-900">
                    <div class="mx-2 text-left">
                        <select name="bonus_type" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40 w-60">
                ...
                <div class="flex mt-5 uppercase">
                    <p class="text-left text-md uppercase text-gray-600 pt-2 leading-none"><span class="font-bold pr-1">{{ $bonus_type }}</span>{{ $year }} <span class="text-xs"></span></p>
                </div>
                        ...
                        @foreach($bonus_report as $b)
                         @if($bonus_type != '')
                            <tr class="bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600">
                                ...
                                <td scope="row" class="py-3 px-6 font-medium text-gray-900 whitespace-nowrap white:text-white"></td>
                                <td scope="row" class="py-3 px-3 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                    <input type="text" name="total_amount" id="total_amount" value="{{ number_format($b->monthly_rate,4) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                                </td>
                                @elseif($bonus_type == 'Healthy')
                                <td scope="row" class="py-3 px-6 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                <input type="text" name="total_leave" id="total_leave"  onkeypress="return isNumberKey(this, event)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                                </td>
                                <td scope="row" class="py-3 px-3 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                <input type="text" name="total_amount" id="total_amount" value="{{ number_format($b->daily_rate,4) }}" readonly="readonly" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                                </td>
                                @elseif($bonus_type == '13th Month')
                                <td scope="row" class="py-3 px-6 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                </td>
                                <td scope="row" class="py-3 px-3 font-medium text-gray-900 whitespace-nowrap white:text-white">
                                    <input type="text" name="total_amount" id="total_amount" value="{{ number_format($b->monthly_rate,4) }}" onkeypress="return isNumberKey(this, event)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
                                </td>
                                @endif
                                <td class="py-3 px-6 justify-center flex" align="center">
                                    <a href="{{ route('payrollbonus.show', '1') }}" class="" title="Update">
