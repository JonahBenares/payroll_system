            ...
            <div class="flex justify-between h-1/2 px-6 ">
                <div class="payslip m-2">
                    <table class="border-2 border-x border-y border-gray-600  payslip_table w-full">
                        ...
                        <tr>
                            <td class="px-1 pt-1 border-b border-gray-600 uppercase  leading-none" colspan="2">Name: <span class="font-bold text-xs">{{ $name->full_name }}</span></td>
                        </tr>
                        @php 
                        ...
                        <tr>
                            ...
                            <span class="font-bold">{{$overtime_amount}}</span>
                            </td>
                        </tr>
                        <tr>
